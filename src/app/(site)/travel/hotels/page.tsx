...
import HotelOption from '../components/hotel-option'
			...
			<div className={s.content}>
				<SectionHeading
					...
					subtitle={
						<>
							<p>
								For each option below, follow the booking instructions to
								reserve. Once we know that one of these options has has been
								fully booked, we will update this page.
							</p>
							<br />
							<p>
				...
				<div className={s.options}>
					...
					<div className={s.smallerOptions}>
						...
						>
							<p>
								The Smith House Inn offers 3 rooms and 1 suite with 2 bedrooms
								(so 5 bedrooms total). All of the rooms are in one house. Click{' '}
								<a href="https://www.book-it-now.com/smithhouseinn/">here</a> to
								learn more about the rates. Contact Amber to book and let her
								know you are with the wedding!
							</p>
							<p>
					...
					<div className={s.smallerOptions}>
						...
						>
							<>
								...
								<ul>
									...
									<li>
										<strong>East wing upstairs:</strong> 1 king & 2 queen
										bedrooms
									</li>
									<li>
						...
						>
							<p>
								...
								amenities. with an en suite bathroom and one with a detached
								(but private) bathroom. There are also 2 single or 1 queen
								inflatable beds available that can be placed in the semi-private
								sunroom.
							</p>
							<p>
								Note: There is another property being built next door that will
								be available by the time of the wedding. It is almost identical
				...
				<div className={s.smallerOptions}>
					<SectionHeading
						...
						subtitle={
							<>
								Please let us know if you book one of these options and we will
								do our best to coordinate transportation. See{' '}
